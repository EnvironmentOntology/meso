 ...
 * [meso.yml](meso.yml)
     * Determines how your purl.obolibrary.org/obo/meso/ redirects will be handled
     ...
     * Paste in the contents of [meso.yml](meso.yml)
 ...
 * [meso.md](meso.md)
     ...
     * Paste in the contents of [meso.md](meso.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
